...
* @returns {Uint8Array}
*/
export function public_key_from_secret(sk) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {Uint8Array}
*/
export function gen_signing_key() {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
...
* @returns {string}
*/
export function encrypt_and_sign(sk, msg, pk) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(sk, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
* @returns {Uint8Array}
*/
export function decrypt_and_verify(sk, msg) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passArray8ToWasm0(sk, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('x25519_chacha20poly1305_wasm_bg.wasm', import.meta.url);
    }
    const imports = getImports();
